package ta.com.component.model;
...
public class TADataStore {
	...
	public void save(String accountName, String password, String server, String userName) {
		saveAccount(server, userName, password, accountName);
	}

	private void saveAccount(String server, String username, String password, String account_name) {
		// account_name = "PJSIP";
		...
		values.put("transport", "1");// 51
		values.put("display_name", account_name);
		values.put("wizard", "BASIC");
		values.put("active", "1");
