package ta.com.component;

import java.util.Timer;
import java.util.TimerTask;

import ta.com.component.base.BaseActivity;
import ta.com.component.base.TAMainApplication;
import ta.com.component.base.TAMainApplication.ClientPresentCallState;
import ta.com.component.base.TAMainApplication.TAMainApplicationCallBackIinit;
import ta.com.component.base.TASipManager;
import ta.com.component.model.TADataStore;
import ta.com.component.view.CallingViewStatus;
import ta.com.component.view.ContactView;
import ta.com.component.view.ContactView.ContactType;
import ta.com.component.view.DTMSView;
import ta.com.component.view.LoginView;
import ta.com.component.view.Menu2View;
import ta.com.component.view.Menu3View;
import ta.com.component.view.MenuLeftView;
import ta.com.component.view.MenuNotificationView;
import ta.com.component.view.MenuUserView;
import ta.org.service.utils.TAMainStatus;
import ta.org.service.utils.TASession;
...
public class TAMainActivity extends BaseActivity {
				...
				if (getClientCallState() == ClientPresentCallState.FREE) {
					new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
						...
						public void run() {
							...
							builder.setTitle("「保留」操作が失敗しました。");
							builder.setMessage("もう一度「保留」操作を実行してください。");
	...
	private void enableClient(final boolean enable, final boolean savePrevious) {
		...
		((TAMainApplication) getApplication()).updateStatus(enable ? ClientStatus.ENABLE : ClientStatus.DISABLE, user_id, new TACallBack() {
			...
			public void onSuccess(String status, String errorMessage, String response) {
				...
				ta_main_on_of.setChecked(enable);
	...
	private ta.com.component.view.Menu5View menu5View;
	private ta.com.component.view.Menu4View menu4View;
	...
	private OnClickListener onClickTaMainBtn = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if (v.getId() == R.id.ta_login_user_infor) {
				...
				// TODO
				ta_main_on_of.setChecked(false);
...
//				setClientCallState(ClientPresentCallState.PRE_PARK);
	...
	private ta.com.component.view.TAWebView ta_main_web;
